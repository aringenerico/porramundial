...
const LANGS = {
  es: {
    // Header / Nav
    pot: 'Bote',
    nav_home: 'Inicio', nav_rules: 'Normas', nav_teams: 'Mis Equipos',
    ...
    // RulesPage
    team_selection: '📋 Selección de Equipos',
    group_label: 'Grupo',
    ...
    // Registration
    reg_closed_title: 'INSCRIPCIÓN CERRADA',
    reg_closed_date: 'La inscripción terminó el',
    reg_closed_end: '7 de junio de 2026',
    step_name: 'Nombre', step_teams: 'Equipos', step_awards: 'Premios', step_confirm: 'Confirmar',
    your_name: '👤 Tu Nombre',
    full_name: 'Nombre completo', full_name_hint: 'Nombre + Apellido',
    ...
    award_preds: '🎯 Predicciones de Premios',
    pts_each: '+10 pts cada uno',
    x_selected: 'seleccionados',
    btn_name: 'Introduce tu nombre para continuar',
    btn_teams: 'Elige todos tus equipos',
    btn_awards: 'Elige las 4 predicciones de premios',
    btn_confirm: '✅ Confirmar inscripción',
    btn_saving: '⏳ Guardando…',
    // Registration success
    reg_ok_title: '¡Inscripción completada!',
    reg_ok_sub: 'Tus equipos y predicciones se han guardado. ¡Buena suerte!',
    ...
    // Results
    search_title: '🔍 Buscar Participante',
    search_ph: 'Nombre del participante…',
    search_btn: 'BUSCAR',
    not_found_pre: 'No se encontró ningún participante con el nombre',
    not_found_post: 'Comprueba la ortografía e inténtalo de nuevo.',
    teams_selected: 'equipos seleccionados',
    total_pts: 'Pts totales',
    award_preds_label: 'Predicciones de Premios',
    points_by_team: '📊 Puntos por Equipo',
    refresh: '↻ Actualizar',
    no_results_title: 'LOS RESULTADOS ESTARÁN DISPONIBLES AL INICIO DEL TORNEO',
    no_results_date: '11 de junio de 2026',
    // Leaderboard
    award_winners: '🏅 Ganadores de Premios',
    no_part_title: 'SIN PARTICIPANTES AÚN',
    no_part_sub: 'Sé el primero en inscribirte',
    pts: 'pts',
    pot_footer: 'Bote total',
    part_footer: 'participantes',
    entry_short: '€10/inscripción',
    refresh_lb: '↻ Actualizar clasificación',
  },

  en: {
    pot: 'Pot',
    nav_home: 'Home', nav_rules: 'Rules', nav_teams: 'My Teams',
    ...
    reg_closed_date: 'Registration ended on',
    reg_closed_end: 'June 7, 2026',
    step_name: 'Name', step_teams: 'Teams', step_awards: 'Awards', step_confirm: 'Confirm',
    your_name: '👤 Your Name',
    full_name: 'Full name', full_name_hint: 'First name + Last name',
    ...
    award_preds: '🎯 Award Predictions',
    pts_each: '+10 pts each',
    x_selected: 'selected',
    btn_name: 'Enter your name to continue',
    btn_teams: 'Pick all your teams',
    btn_awards: 'Pick all 4 award predictions',
    btn_confirm: '✅ Confirm registration',
    btn_saving: '⏳ Saving…',
    reg_ok_title: 'Registration complete!',
    reg_ok_sub: 'Your teams and predictions have been saved. Good luck!',
    your_award_preds: '🎖️ YOUR AWARD PREDICTIONS',
    select_player: 'Select player',
    loading_players: 'Loading players…',
    search_players: 'Search players…',
    no_results_for: 'No results for',
    search_title: '🔍 Search by Participant',
    search_ph: 'Enter participant name…',
    search_btn: 'SEARCH',
    not_found_pre: 'No participant found with the name',
    not_found_post: 'Check the spelling and try again.',
    teams_selected: 'teams selected',
    total_pts: 'Total pts',
    award_preds_label: 'Award Predictions',
    points_by_team: '📊 Points by Team',
    refresh: '↻ Refresh',
    no_results_title: 'RESULTS WILL BE AVAILABLE ONCE THE TOURNAMENT BEGINS',
    no_results_date: 'June 11, 2026',
    award_winners: '🏅 Award Winners',
    no_part_title: 'NO PARTICIPANTS YET',
    no_part_sub: 'Be the first to register',
    pts: 'pts',
    pot_footer: 'Total pot',
    part_footer: 'participants',
    entry_short: '€10/entry',
    refresh_lb: '↻ Refresh leaderboard',
  },

  pt: {
    pot: 'Prêmio',
    nav_home: 'Início', nav_rules: 'Regras', nav_teams: 'Meus Times',
    ...
    team_selection: '📋 Seleção de Times',
    group_label: 'Grupo',
    ...
    reg_closed_title: 'INSCRIÇÕES ENCERRADAS',
    reg_closed_date: 'As inscrições encerraram em',
    reg_closed_end: '7 de junho de 2026',
    step_name: 'Nome', step_teams: 'Times', step_awards: 'Prêmios', step_confirm: 'Confirmar',
    your_name: '👤 Seu Nome',
    full_name: 'Nome completo', full_name_hint: 'Nome + Sobrenome',
    ...
    award_preds: '🎯 Previsões de Prêmios',
    pts_each: '+10 pts cada',
    x_selected: 'selecionados',
    btn_name: 'Digite seu nome para continuar',
    btn_teams: 'Escolha todos os seus times',
    btn_awards: 'Escolha as 4 previsões de prêmios',
    btn_confirm: '✅ Confirmar inscrição',
    btn_saving: '⏳ Salvando…',
    reg_ok_title: 'Inscrição concluída!',
    reg_ok_sub: 'Seus times e previsões foram salvos. Boa sorte!',
    your_award_preds: '🎖️ SUAS PREVISÕES DE PRÊMIOS',
    select_player: 'Selecione jogador',
    loading_players: 'Carregando jogadores…',
    search_players: 'Buscar jogadores…',
    no_results_for: 'Sem resultados para',
    search_title: '🔍 Buscar Participante',
    search_ph: 'Digite o nome do participante…',
    search_btn: 'BUSCAR',
    not_found_pre: 'Nenhum participante encontrado com o nome',
    not_found_post: 'Verifique a ortografia e tente novamente.',
    teams_selected: 'times selecionados',
    total_pts: 'Pts totais',
    award_preds_label: 'Previsões de Prêmios',
    points_by_team: '📊 Pontos por Time',
    refresh: '↻ Atualizar',
    no_results_title: 'OS RESULTADOS ESTARÃO DISPONÍVEIS QUANDO O TORNEIO COMEÇAR',
    no_results_date: '11 de junho de 2026',
    award_winners: '🏅 Vencedores de Prêmios',
    no_part_title: 'SEM PARTICIPANTES AINDA',
    no_part_sub: 'Seja o primeiro a se inscrever',
    pts: 'pts',
    pot_footer: 'Prêmio total',
    part_footer: 'participantes',
    entry_short: '€10/inscrição',
    refresh_lb: '↻ Atualizar classificação',
  },
};
...
:root {
  --bg:    #06090f; --sur:  #0c1220; --sur2: #111827; --sur3: #161f30;
  --brd:   #1a2438; --brd2: #243050;
  --gold:  #F5B731; --gold2:#c7921b; --green:#22d48e;
  --blue:  #5a9fff; --pink: #ff6b8a;
  --txt:   #c8d0e0; --mut:  #4e5e78; --white:#eef2ff;
  --r:     12px;
  --tr:    all .18s ease;
}
...
@media (prefers-reduced-motion: reduce) {
  .skeleton { animation: none; background: var(--sur2); }
...
/* ── AWARD PICK DISPLAY (leaderboard) ── */
...
@media (max-width:480px) {
  ...
  .award-dropdown { max-width:calc(100vw - 48px); }
  .sel-progress { gap:5px; }
  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      >
        ...
        <span className="award-trigger-val">
          {value || (players.length === 0 ? t.loading_players : t.select_player)}
        </span>
      ...
      {open && (
        <div className="award-dropdown" role="listbox">
          ...
          <div className="award-list">
            {filtered.length === 0
              ? <div className="award-empty">{t.no_results_for} "{q}"</div>
              : filtered.map(p => (
                <button
                  key={p.id}
                  type="button"
                  ...
                  className={`award-opt ${value === p.name ? 'active' : ''}`}
                  onClick={() => { onChange(p.name); setOpen(false); setQ(''); }}
                >
                  <span>{p.name}</span>
                  <span className="award-opt-team">
                    {p.team}
                    {value === p.name && <span style={{ color: 'var(--gold)', marginLeft: 6 }}>✓</span>}
                  </span>
                </button>
              ))
            }
...
function LoadingScreen() {
  return (
    <div className="page" style={{ paddingTop: 32 }}>
      ...
      <div style={{ background: 'var(--sur)', border: '1px solid var(--brd)', borderRadius: 12, padding: 20 }}>
    ...
    <div className="page">
      <div className="hero">
        ...
        <div className="hero-grid">
          <div className="hero-stat">
            ...
            <div className="hero-stat-lbl">{t.participants}</div>
          </div>
          <div className="hero-stat">
            <div className="hero-stat-val" style={{ color: 'var(--gold)' }}>€{pot}</div>
            <div className="hero-stat-lbl">{t.total_pot}</div>
          </div>
          <div className="hero-stat">
            <div className="hero-stat-val">7</div>
            <div className="hero-stat-lbl">{t.teams_entry}</div>
          </div>
        </div>
      ...
      <div className="card">
        ...
        <div style={{ display: 'grid', gap: 10 }}>
          {[
            ...
            <div key={s.n} style={{ display:'flex', gap:14, alignItems:'flex-start', background:'var(--sur2)', border:'1px solid var(--brd)', borderRadius:10, padding:14, transition:'var(--tr)' }}>
              ...
              <div>
                <div style={{ fontWeight:600, color:'var(--white)', marginBottom:2, fontSize:15 }}>{s.t}</div>
                <div style={{ fontSize:13, color:'var(--mut)' }}>{s.d}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="card" style={{ background:'linear-gradient(135deg,#0e1e38,#091428)' }}>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:12, textAlign:'center' }}>
          {[
            { lbl:t.prize1, pct:'75%', col:'var(--gold)', medal:'🥇', amt:Math.round(pot*0.75) },
            { lbl:t.prize2, pct:'20%', col:'#c0c8d8',    medal:'🥈', amt:Math.round(pot*0.20) },
            { lbl:t.prize3, pct:'5%',  col:'#a07040',    medal:'🥉', amt:Math.round(pot*0.05) },
          ].map(p => (
      ...
      {open ? (
        <button className="btn-primary" onClick={() => goTo('seleccion')}>{t.register_btn}</button>
      ) : (
        <div style={{ textAlign:'center', padding:'14px 0', fontSize:13, color:'var(--mut)' }}>
          {t.reg_closed_msg}
        </div>
      )}
    </div>
...
function RulesPage({ t }) {
  const scoring = [
    { icon:'⚽', lbl:t.sc_goal,  pts:1,  note:'' },
    { icon:'🏆', lbl:t.sc_win,   pts:3,  note:t.sc_win_n },
    { icon:'🤝', lbl:t.sc_draw,  pts:1,  note:t.sc_draw_n },
    { icon:'➡️', lbl:t.sc_adv,   pts:6,  note:t.sc_adv_n },
    { icon:'🥇', lbl:t.sc_champ, pts:10, note:t.sc_champ_n },
    { icon:'👟', lbl:t.sc_top,   pts:8,  note:t.sc_top_n },
    { icon:'🛡️', lbl:t.sc_def,  pts:6,  note:t.sc_def_n },
  ];
    ...
    <div className="page">
        ...
        {Object.entries(GROUPS).map(([key,g]) => (
          <div className="grupo-strip" key={key}>
            ...
            <div style={{ fontSize:13, color:'var(--txt)' }}>
              {t.pick_team} <strong style={{ color:'var(--white)' }}>{g.pick}</strong> {g.pick > 1 ? t.pick_team_p : t.pick_team_s}
            </div>
      ...
      <div className="card" style={{ background:'linear-gradient(135deg,#0e1e38,#091428)', border:'1px solid rgba(245,183,49,0.2)' }}>
        ...
        <div style={{ fontSize:13, color:'var(--mut)', marginBottom:14 }}>
          {t.award_bonus_desc}{' '}
          <strong style={{ color:'var(--gold)' }}>+10 pts</strong>. {t.award_bonus_max} <strong style={{ color:'var(--green)' }}>+40 pts</strong>.
        </div>
        <div className="scoring-grid">
          {AWARD_CONFIG.map(a => (
      ...
      <div className="card">
        ...
        <div className="premio-grid">
          {[
            { medal:'🥇', pos:t.winner, pct:75, col:'var(--gold)' },
            { medal:'🥈', pos:t.second, pct:20, col:'#b0b8cc' },
            { medal:'🥉', pos:t.third,  pct:5,  col:'#9a7050' },
          ].map(p => (
...
function RegistrationPage({ onSubmit, t }) {
  ...
  const allTeams    = () => {
    const teams = [];
    if (sel.g1) teams.push(sel.g1);
    teams.push(...sel.g2, ...sel.g3);
    if (sel.g4) teams.push(sel.g4);
    return teams;
  };
    ...
    <div className="page">
      <div className="success-box">
        ...
        <div style={{ display:'flex', flexWrap:'wrap', gap:6, justifyContent:'center' }}>
          {allTeams().map(tm => <span key={tm} className="sum-chip">{FLAGS[tm]||'🏳️'} {tm}</span>)}
        </div>
    ...
    <div className="page">
      ...
      {allTeams().length > 0 && (
        <div className="sel-summary">
          ...
          <div className="sum-teams">{allTeams().map(tm => <span key={tm} className="sum-chip">{FLAGS[tm]||'🏳️'} {tm}</span>)}</div>
        </div>
      )}
          ...
          {AWARD_CONFIG.map(a => (
            <div className="award-item" key={a.key}>
              <label>
                ...
                {a.label}
                {picks[a.key] && <span style={{ marginLeft:'auto', color:'var(--gold)', fontSize:12 }}>✓</span>}
              </label>
              <AwardSelect
                config={a}
                players={players[a.key]}
                value={picks[a.key]}
                onChange={val => setPicks(p => ({ ...p, [a.key]: val }))}
                t={t}
              />
            </div>
          ))}
      ...
      <div style={{ marginTop:16 }}>
        <button className="btn-primary" onClick={handleSubmit} disabled={!name.trim() || !allSelected() || !allPicks() || submitting}>
          {submitting ? t.btn_saving
            : !name.trim() ? t.btn_name
            : !allSelected() ? `${t.btn_teams} (${allTeams().length}/7)`
            : !allPicks() ? `${t.btn_awards} (${AWARD_CONFIG.filter(a => picks[a.key]).length}/4)`
            : t.btn_confirm}
        </button>
      </div>
    </div>
            ...
            <tr key={r.team}>
              <td>
                <div className="res-team">
                  {showIndex && <span style={{ width:22, textAlign:'center', fontFamily:"'Barlow Condensed',sans-serif", fontWeight:700, fontSize:13, color:'var(--mut)' }}>{i+1}</span>}
...
function ResultsPage({ resultsMap, participants, onRefresh, t }) {
  const [query,    setQuery]    = useState('');
  const [searched, setSearched] = useState(false);

  const allSorted = Object.values(resultsMap)
  ...
  const participantRows = foundParticipant
    ? foundParticipant.teams
        .map(tm => ({ ...(resultsMap[tm] || { team:tm, j1:0, j2:0, j3:0, r32:0, r16:0, qf:0, sf:0, final:0 }) }))
        .map(r => ({ ...r, _total: calcTotal(r) }))
        .sort((a,b) => b._total - a._total)
    : [];
    ...
    <div className="page">
      ...
      <div className="card">
        ...
        <form onSubmit={handleSearch} style={{ display:'flex', gap:8 }}>
          ...
          />
          <button type="submit" style={{ background:'var(--gold)', border:'none', borderRadius:8, padding:'0 18px', color:'#080c14', fontFamily:"'Barlow Condensed',sans-serif", fontWeight:800, fontSize:13, letterSpacing:1, cursor:'pointer', whiteSpace:'nowrap', minHeight:44 }}>
            {t.search_btn}
          </button>
          {searched && (
            <button type="button" className="btn-ghost" onClick={handleClear}>✕</button>
          )}
        </form>
        {notFound && (
          <div className="error-box" style={{ marginTop:10, marginBottom:0 }}>
            ⚠️ {t.not_found_pre} "<strong>{query}</strong>". {t.not_found_post}
          </div>
        )}
      </div>
          ...
          {AWARD_CONFIG.some(a => foundParticipant[a.col]) && (
            <div style={{ marginTop:14, paddingTop:14, borderTop:'1px solid var(--brd)' }}>
              ...
              <div style={{ display:'flex', flexWrap:'wrap', gap:6 }}>
                {AWARD_CONFIG.filter(a => foundParticipant[a.col]).map(a => (
                  <span key={a.key} className="sum-chip">{a.icon} {foundParticipant[a.col]}</span>
                ))}
              </div>
            </div>
          )}
  ...
  const PickChips = ({ p }) => (
    <div style={{ display:'flex', flexWrap:'wrap', gap:5, marginTop:5 }}>
      {AWARD_CONFIG.filter(a => p[a.col]).map(a => {
        ...
        return (
          <span key={a.key} style={{ display:'inline-flex', alignItems:'center', gap:4, fontSize:11, padding:'2px 8px', borderRadius:5, background:correct ? 'rgba(34,212,142,0.12)' : 'rgba(255,255,255,0.05)', border:correct ? '1px solid rgba(34,212,142,0.35)' : '1px solid var(--brd)', color:correct ? 'var(--green)' : 'var(--mut)' }}>
  ...
  return (
    <div className="page">
            ...
            return (
              <div className="podium-card" key={p.name} style={{ background:podBg[ri], borderColor:`${podColors[ri]}40`, order:ri===0?2:ri===1?1:3 }}>
                ...
                <div className="podium-teams">
                  {p.teams.map(tm => <span key={tm} className="podium-team-chip">{FLAGS[tm]||'🏳️'} {tm}</span>)}
                </div>
                <div style={{ display:'flex', flexWrap:'wrap', gap:4, justifyContent:'center', marginTop:8 }}>
                  {AWARD_CONFIG.filter(a => p[a.col]).map(a => {
                    const correct = winnersMap[a.key] && p[a.col] === winnersMap[a.key];
                    return (
                      <span key={a.key} style={{ fontSize:10, padding:'2px 6px', borderRadius:4, background:correct?'rgba(34,212,142,0.15)':'rgba(255,255,255,0.06)', border:correct?'1px solid rgba(34,212,142,0.35)':'1px solid rgba(255,255,255,0.08)', color:correct?'var(--green)':'var(--mut)' }}>
                        {a.icon} {p[a.col]}{correct && ' ✓'}
                      </span>
                    );
                  })}
      ...
      {rest.map((p, i) => {
        ...
        const accentColor = !showPodium && pos === 1 ? 'var(--gold)' : !showPodium && pos === 2 ? '#b0b8cc' : !showPodium && pos === 3 ? '#9a7050' : 'transparent';
        return (
          <div className="clasif-row" key={p.name} style={{ borderLeftColor: accentColor }}>
            <div className="clasif-pos" style={!showPodium && i === 0 ? { background:'rgba(245,183,49,0.15)', borderColor:'rgba(245,183,49,0.4)', color:'var(--gold)' } : {}}>
              {pos}
            </div>
            <div style={{ flex:1, minWidth:0 }}>
              ...
              <div className="clasif-teams-mini">
                {p.teams.map(tm => <span key={tm} className="clasif-team-chip">{FLAGS[tm]||'🏳️'} {tm} · </span>)}
              </div>
              <PickChips p={p} />
            </div>
      ...
      <div style={{ textAlign:'center', padding:16, fontSize:12, color:'var(--mut)', marginTop:4 }}>
        {t.pot_footer}: <strong style={{ color:'var(--gold)' }}>€{pot}</strong> · {participants.length} {t.part_footer} · {t.entry_short}
        <br/>
...
export default function App() {
  ...
  async function loadData() {
    ...
    setWinnersMap({
      ...
      mvp:             row.mvp          || '',
      best_young:      row.young        || '',
      best_goalkeeper: row.goalkeeper   || '',
    });
    setLoading(false);
  }

  const calcBonus = (p) =>
    AWARD_CONFIG.filter(a => winnersMap[a.key] && p[a.col] === winnersMap[a.key]).length * AWARD_BONUS;
  ...
  const navTabs = [
    { id:'inicio',        l: t.nav_home },
    { id:'normas',        l: t.nav_rules },
    { id:'seleccion',     l: t.nav_teams },
    { id:'resultados',    l: t.nav_results },
    { id:'clasificacion', l: t.nav_leaderboard },
  ...
  return (
    <>
      ...
      <div className="hdr">
        <div className="hdr-top">
          ...
          <div className="hdr-bote">
            <div className="hdr-bote-lbl">{t.pot}</div>
            <div className="hdr-bote-val">€{pot}</div>
          </div>
        </div>
        <nav className="nav">
          {navTabs.map(nt => (
            <button key={nt.id} className={`nav-btn ${nt.id === tab ? 'on' : ''}`}
      ...
      {tab === 'resultados'    && <ResultsPage      resultsMap={resultsMap} participants={participants} onRefresh={loadData} t={t} />}
